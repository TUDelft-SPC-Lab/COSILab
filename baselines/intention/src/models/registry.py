...
#
# The Qwen size is part of the backend name rather than a separate flag: the name
# is what a run records and what the job scripts turn into a results directory,
# so "which weights ran" stays answerable from the backend alone. A second size
# is one more line here plus a backends.qwen3b section in the task's
# model_config.json, both pointing at the same class.
